...
void Renderer::renderParticles(Camera* camera_, ShaderManager::HandleType shaderHandle_, ParticleEmitter* particles_, std::vector<Light*> lights_)
{
	Shader* shader = ShaderManager::getInstance()->getShader(shaderHandle_);
